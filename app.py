...
def run_streamlit_app():
    ...
    if mgf_file and mztab_file:
        # ⚡ OPTIMIZATION: Use TextIOWrapper to stream file content instead of reading everything into memory
        # Original: io.StringIO(mgf_file.read().decode('utf-8')) - High memory usage (Bytes + String + StringIO)
